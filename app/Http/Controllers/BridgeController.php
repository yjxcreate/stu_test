...
class BridgeController extends Controller
{
    ...
    public function completion(Completion2Request $request){
        ...
        if(0 < $rx1 && $rx1 < 999 && sprintf("%.2f",$rx1) == sprintf("%.2f",$ra1*0.1)){
             $grade += 2;
            
             
        }
            if(0 < $rx2 && $rx2 < 999 && sprintf("%.2f",$rx2) == sprintf("%.2f",$ra2*0.1)){
            $grade += 2;
        }
        if(0 < $rx3 && $rx3 < 999 && sprintf("%.2f",$rx3) == sprintf("%.2f",$ra3*0.1)){
            $grade += 2;
        }
        ...
        if($rchange1a <= 9999 && $rchange1a >0){
            $grade += 2;
        }

        if($rchange2a <= 9999 && $rchange2a >0){
            $grade += 2;
        }
        if($rchange3a <= 9999 && $rchange3a >0){
            $grade += 2;
        }//24
