...
class PendulumController extends Controller
{
        ...
        public  function completion3(Completion3Request  $request)
    {
        ...
        if($g>9.5 && $g<12.5 &&  effective($g) == 3 ){
            $grade += 5;
        }

        if($n1>0 && $n1<2 && effective($n1) == 1 ){
            $grade += 5;
        }

        if($n2>0 && $n2<2 && effective($n2) == 2){
            $grade += 5;
        }

        if($n3>0 && $n3<2 && effective($n3) == 1){
            $grade += 5;
        }


        if($n4>0 && $n4<2 && effective($n4) == 2){
            $grade += 5;
        }

        if($n5>0 && $n5<3 && effective($n5) == 2){
            $grade += 5;
        }

        if($n6>0 && $n6<1 && effective($n6) == 1){
            $grade += 5;
        }
