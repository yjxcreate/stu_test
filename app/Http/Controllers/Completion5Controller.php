 ...
 */
    public function completion5(Completion5Request  $request){
        ...
        if(0 < $rx_a1 && $rx_a1 < 9999&& $rx_a1==$ra1){
            $grade += 2;
        }
      
        if(0 < $rx_a2 && $rx_a2 < 9999 &&$rx_a2==$ra2 ){
            $grade += 2;
        }
          
        if(0 < $rx_a3 && $rx_a3 < 9999 && $rx_a3==$ra3){
            $grade += 2;
        }
        ...
        if($rb1 == $ra1&&0 < $rb1 && $rb1< 999 ){
            $grade += 2;
        }
          
        if($rb2 == $ra2&&0 < $rb2 && $rb2< 999  ){
            $grade += 2;
        }
          
        if($rb3 == $ra3&& 0 < $rb3 && $rb3< 999 ){
            $grade += 2;
        }
        ...
        if($rx_b1 == 1/2*$rc1 &&$rx_b1 > 0 && $rx_b1 < 999){
            $grade += 2;
        }
       
        if($rx_b2 == 2*$rc2 &&$rx_b2 > 0 && $rx_b2 < 999){
            $grade += 2;
        }
       
        if($rx_b3 == 4*$rc3 &&$rx_b2 > 0 && $rx_b2 < 999){
            $grade += 2;
        }
        

        if($rxx == sprintf("%.2f",($rx_b1+$rx_b2+$rx_b3)/3) && $rxx > 0 && $rxx < 999){
            $grade += 2;
        }
         

        if($rd1 == $rc1&& $rd1 > 0 && $rd1 < 999){
            $grade += 2;
        }
       
        if($rd2 == $rc2&& $rd2 > 0 && $rd2 < 999){
            $grade += 2;
        }
          
        if($rd3 == $rc3&& $rd3 > 0 && $rd3 < 999){
            $grade += 2;
        }
